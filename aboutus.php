    ...
    <div class="wrapper">
        ...
        <main role="main">
            ...
            <section id="hero" class="section section-hero section--dark">
                <img src="img/about_us_hero.jpg" class="img-responsive" />
            </section><!-- /section -->
                                            


           <section id="section-raw-html-grabnow-intro-pax" class="section section--padded section--light section-raw-html" style="                                             ">

    <div class="container">

        <header>
            <h2>Introducing Jinan Rides</h2>
        </header>
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <p>Jinan Rides is the most rewarding way to book a ride! Once you&#8217;ve booked your ride, you can select &#8220;Jinan Rides&#8221; in your Jinan Rides app, and you can book a ride on the spot with your rider!</p>
                <p>This way, you can enjoy your usual Jinan Rides benefits like JinanRideRewards, cashless payments and promo codes, with all the instant convenience of flagging a taxi.</p>
                <p>*Special launch offer<br /> Try it today with promo code <strong>JINANRIDESNOW</strong> to get 100 BDT OFF every time you book a ride with Jinan Rides.</p>
                <p style="font-size:0.9em; margin-bottom:0;">*Terms &#038; Conditions:</p>
                <ul style="font-size:0.9em;">
                    <li>&#8220;Jinan Rides&#8221; promotion is only valid for a limited time till 31st January 2018</li>
                    <li>Promo code is only valid for use on Jinan Rides rides only</li>
                    <li>All payment methods are accepted for this promotion</li>
                </ul>
...
<section id="section-list-group-horizontal-grabnow-why-grabnow-pax" class="section section--padded section--light section-list-group-horizontal section-icon-list" style="background-color: #f1f1f1;                                                ">

    <div class="container">

        <header>
            <h2>Why Jinan Rides</h2>
        </header>
        <style>
        ...
        <div class="row row-horizontal">
            <div class="col-xs-12 col-md-3">
                <img src="img/Icons-02-1.png">
                <h4 class="color-green text-center"></h4>
                <p class="text-center">Fuss-free cashless payments via JinanRidePay (credit/debit card or Jinan Rides Credits)</p>
            </div>
            <div class="col-xs-12 col-md-3">
                <img src="img/Icons-01-1.png">
                <h4 class="color-green text-center"></h4>
                <p class="text-center">No admin fees for cashless payment and no standard taxi booking fees</p>
            </div>
            <div class="col-xs-12 col-md-3">
                <img src="img/Icons-03-1.png">
                <h4 class="color-green text-center"></h4>
                <p class="text-center">Earn JinanRidesRewards Points to redeem discounted Jinan rides and other goodies</p>
            </div>
            <div class="col-xs-12 col-md-3">
                <img src="img/Icons-04-1.png">
                <h4 class="color-green text-center"></h4>
                <p class="text-center">Enjoy attractive promotions</p>
            </div>
        </div>
        <!-- /row -->
...
<section id="section-raw-html-grabnow-how-to-use-pax" class="section section--padded section--light section-raw-html" style="                                               ">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="row">
                    <div class="col-md-7">
                        <h3 style="color: #00BA51; text-align: center;">
                            <strong><u>Auto Pairing</u></strong><br />
                        </h3>
                        <ol>
                            <li>Ask your Rider if he/she accepts JinanRideNow</li>
                            <li>Select &#8216;Standard Pay&#8217;</li>
                            <li>Tap &#8216;JINANRIDENOW&#8217; and ask your rider to do the same</li>
                            <li>Pair your app with your JinanRide driver by pressing &#8216;CONNECT&#8217;</li>
                            <li>&#8216;CONFIRM&#8217; your driver, and be on your way!</li>
                        </ol>
                        <p> <em><strong>TIP &#8211; Choose JinanPay for fuss free cashless payment with no admin fees!</strong></em>
                    </div>
                    <div class="col-md-5">
                        <div class="img-holder" style="text-align: center;"><img src="img/source.gif" style="max-height: inherit; max-width: 140px;"></div>
                        </p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-7">
                        <h3 style="color: #00BA51; text-align: center;">
                            <strong><u>Manual Pairing</u></strong><br />
                        </h3>
                        <p class="sidenote" style="padding-left:40px">If you encounter any difficulty with “Auto Pairing”, you can simply pair manually by entering a 6 digit code generated from the driver’s phone.</p>
                        </p>
                    </div>
                    <div class="col-md-5">
                        <div class="img-holder"  style="text-align: center;"><img src="img/source3.gif" style="max-height: inherit; max-width: 160px;"></p>
                            <div>
                            </div>
                        </div>
...
<section id="section-faq-single-grabnow-faq-pax" class="section section--padded section--light section-faq-single" style="                                              ">
        ...
        <div class="row">
            <div class="col-xs-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
                <div role="tabpanel" class="tab-pane" id="PassengerTabGrabTaxi">
                    ...
                    <div class="panel-group panel-group--accordion">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h5 class="panel-title collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse23098" aria-expanded="false" aria-controls="collapse23098">Question 1?</h5>
                            </div>
                            <div id="collapse23098" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading23098">
                                <div class="panel-body">
                                    <p>Answers to FAQ Question 1. Answers to FAQ Question 1. Answers to FAQ Question 1</p>
                                </div>
                            </div>
                            <!-- /panel-collapse -->
                        </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h5 class="panel-title collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse23100" aria-expanded="false" aria-controls="collapse23100">Question 2?</h5>
                            </div>
                            <div id="collapse23100" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading23100">
                                <div class="panel-body">
                                    <p>Answers to FAQ Question 2 Answers to FAQ Question 2. Answers to FAQ Question 2</p>
                                </div>
                            </div>
                            <!-- /panel-collapse -->
                        </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h5 class="panel-title collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse23103" aria-expanded="false" aria-controls="collapse23103">Question 3?</h5>
                            </div>
                            <div id="collapse23103" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading23103">
                                <div class="panel-body">
                                    <p>Answers to FAQ Question 3. Answers to FAQ Question 3. Answers to FAQ Question 3.</p>
                                </div>
                            </div>
                            <!-- /panel-collapse -->
                        </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h5 class="panel-title collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse23105" aria-expanded="false" aria-controls="collapse23105">Question 4?</h5>
                            </div>
                            <div id="collapse23105" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading23105">
                                <div class="panel-body">
                                    <p>Answers to FAQ Question 4. Answers to FAQ Question 4. Answers to FAQ Question 4.</p>
                                </div>
                            </div>
                            <!-- /panel-collapse -->
                        </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h5 class="panel-title collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse23106" aria-expanded="false" aria-controls="collapse23106">Question 5?</h5>
                            </div>
                            <div id="collapse23106" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading23106">
                                <div class="panel-body">
                                    <p>Answers to FAQ Question 5. Answers to FAQ Question 5. Answers to FAQ Question 5.</p>
                                </div>
                            </div>
                            <!-- /panel-collapse -->
                        </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h5 class="panel-title collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse23107" aria-expanded="false" aria-controls="collapse23107">Question 6?</h5>
                            </div>
                            <div id="collapse23107" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading23107">
                                <div class="panel-body">
                                    <p>Answers to FAQ Question 6. Answers to FAQ Question 6. Answers to FAQ Question 6.</p>
                                </div>
                            </div>
                            <!-- /panel-collapse -->
                        </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h5 class="panel-title collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse23527" aria-expanded="false" aria-controls="collapse23527">Question 7</h5>
                            </div>
                            <div id="collapse23527" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading23527">
                                <div class="panel-body">
                                    <p>Answers to FAQ Question 7. Answers to FAQ Question 7. Answers to FAQ Question 7.</p>
                                </div>
                            </div>
                            <!-- /panel-collapse -->
                        </div>
