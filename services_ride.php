...
<body class="home page-template page-template-tpl page-template-tpl-page-sections page-template-tpltpl-page-sections-php page page-id-285 site-id-4">
    ...
    <div class="wrapper">
        ...
        <section id="hero" class="section section-hero section--dark bg-size-cover test" style="z-index:9;background-image: url(img/hero-jinantaxi-1.jpg); ">
    ...
    <div class="container hero-content" style="">
        <div class="section-body">
            ...
            <h1 style="color: black !important;">Jinan Ride </h1>
            <p style="color: black !important;">Your access to Bangladesh’s largest network of taxis.</p>
